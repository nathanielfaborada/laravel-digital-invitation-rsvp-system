<x-app-layout>
    ...
    <div x-data="{
        ...
        coverFileName: @js($event->cover_image ? basename($event->cover_image) : ''),
        ...
        previewCoverImage(event) {
            ...
            if (!file) { 
                ...
                this.coverFileName = @js($event->cover_image ? basename($event->cover_image) : '');
                return; 
            }
                        ...
                        <div>
                            <form action="{{ route('events.update', $event) }}" method="POST" enctype="multipart/form-data" class="flex flex-col justify-between min-h-[520px] sm:min-h-0">
                                ...
                                <div class="space-y-2 sm:space-y-4">
                                    ...
                                    <div>
                                        <label class="block text-xs font-medium text-gray-700 mb-1">Cover Image (leave blank to keep current)</label>
                                        <div class="relative">
                                    ...
                                    <!-- 2. Invitation Template Selector -->
                                    <div>
                                ...
                                <div class="flex gap-2 pt-4 mt-6">
                                    ...
                                    <a href="{{ route('events.show', $event) }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300 text-xs sm:text-sm font-medium transition-colors">
                                        Cancel
                                    </a>
                                </div>
