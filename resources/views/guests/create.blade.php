            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('events.guests.store', $event) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="max_companions" min="0" value="{{ old('max_companions', 0) }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        <p class="text-xs text-gray-500 mt-1">How many additional people can this guest bring?</p>
                    </div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('events.guests.index', $event) }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300">
                            Cancel
                        </a>
                    </div>
                </form>
